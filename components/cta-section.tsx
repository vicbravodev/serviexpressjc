      ...
      <div className="container mx-auto px-4">
        <RevealGroup className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <Card id="cotizacion" className="h-full p-8 border-border">
            <span className="font-mono text-xs uppercase tracking-[0.22em] text-muted-foreground">Clientes · B2B</span>
            <h3 className="mt-2 text-2xl font-bold mb-2">Solicita tu cotización</h3>
            <p className="text-muted-foreground mb-6">
              Cuéntanos tu ruta y tu carga; te respondemos con una propuesta a la medida.
            </p>
        ...
        <Reveal className="mt-12 text-center">
          <Card className="mx-auto max-w-2xl border border-white/10 surface-steel p-8 text-white">
            <h3 className="text-2xl font-bold mb-3">¿Necesitas ayuda inmediata?</h3>
            <p className="mb-6 text-white/70">Escríbenos por WhatsApp y te respondemos en minutos.</p>
